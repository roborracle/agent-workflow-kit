---
name: skill-builder
description: Guide the creation, optimization, or auditing of Claude Code skills following official best practices (create a skill, build a skill, audit skill, optimize skill).
argument-hint: [new|audit|optimize]
---
...
After creating a skill, add it to `~/.claude/skills/INDEX.md` (for global skills) or document it in the project's CLAUDE.md. Include:
- Skill name and invocation type (Auto + Manual, Manual only, Auto only)
- Whether it's forked
- Brief description
...
2. Extract: Attendees, Key decisions, Action items (who/what/deadline), Open questions.
...
- [ ] Skill is registered in INDEX.md (for global skills) or documented in CLAUDE.md
